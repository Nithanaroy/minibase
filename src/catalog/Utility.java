...
public class Utility implements Catalogglobal {
	...
	public static void insertRecordUT(String relation, int attrCnt, attrNode[] attrList) throws Catalogmissparam, Catalogrelexists,
			Catalogdupattrs, Catalognomem, IOException, Catalogioerror, Cataloghferror, Catalogrelnotfound, Catalogindexnotfound,
	...
	public static void insertRecUT(String relation, int attrCnt, attrNode[] attrList) throws Catalogmissparam, Catalogrelexists,
			Catalogdupattrs, Catalognomem, IOException, Catalogioerror, Cataloghferror, Catalogrelnotfound, Catalogindexnotfound,
			Catalogattrnotfound, Catalogbadattrcount, Catalogattrexists, Catalogbadtype, Exception {
		RelDesc relRec = null;
		RID rid = null;
